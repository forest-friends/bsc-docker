...
RUN sed '/\[Node.LogConfig\]/d;/File[Root|Path]/d;/MaxBytesSize/d;/Level/d' testnet/config.toml > testnet/config-without-logs.toml && \
    sed '/\[Node.LogConfig\]/d;/File[Root|Path]/d;/MaxBytesSize/d;/Level/d' mainnet/config.toml > mainnet/config-without-logs.toml
